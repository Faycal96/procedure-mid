                                        ...
                                        <?php if (!is_null($demandes)) { ?>
                                            ...
                                            <tr class="table-bordered">
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <button title="Payer" type="button" class="btn btn-warning " data-bs-toggle="modal" data-bs-target="#largeModalPaiement{{ $demande->uuid }}"> <i class="bi bi-cash-stack"></i></button>
                                                    @endif
                                                    @endif
                                                ...
                                                <div class="modal" id="largeModalPaiement{{ $demande->uuid }}">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                 ...
                                                                 <div class="form-card">
                                                                    ...
                                                                    <label for="demande timbre" class="fw-bold">Moyens de Paiement<span style="color:red">*</span></label>
                                                                    <div class="row">
                                                                         <div class="col-3">
                                                                    ...
                                                                    <div class="row">
                                                                        <div id="moyenP1">
                                                                            ...
                                                                            <strong><input name="montantTotal" value="{{$demande->montant}}" disabled readonly class="form-control border-success"></input></strong><br> 
                                                                            <label>En cliquant sur le bouton "<b>Payer</b>" vous serez redirigé vers le site de Ligdicash afin de procéder au paiement</label>
                                                                            <button type="button" class="btn btn-primary"><a href="{{ route('rePaiement', ['uuid' => $demande->uuid, 'moyen' =>1]) }}">Payer</a></button>
                                                                        </div>
