                                                   ...
                                                   <div class="modal-dialog" role="document">
                                                       <div class="modal-content bgcustom-gradient-light">
                                                           ...
                                                           <div class="modal-body">
                                                               <form method="post" enctype="multipart/form-data" action="{{ route('statusChange', ['id' =>$demande->uuid, 'currentStatus' => $demande->etat ,'table'=> 'demande_p002_s'] ) }}">
                                                                   @csrf
                                               ...
                                               <div class="modal fade" id="signer{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                                   <div class="modal-dialog" role="document">
                                                       <div class="modal-content bgcustom-gradient-light">
                                                           ...
                                                           <div class="modal-body">
                                                               <form method="post" enctype="multipart/form-data" action="{{ route('uploadActe', ['id' =>$demande->uuid, 'currentStatus' => $demande->etat ,'table'=> 'demande_p002_s'] ) }}">
                                                                   @csrf
                                               ...
                                               <div class="modal fade" id="rejetter{{ $demande->uuid }}" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                                   <div class="modal-dialog" role="document">
                                                       <div class="modal-content bgcustom-gradient-light">
                                                           ...
                                                           <div class="modal-body">
                                                               <form method="put" action="{{ route('rejetter', ['id' =>$demande->uuid, 'table' => 'demande_p002_s']) }}">
                                                                   @csrf
                                                                   @method('PUT')
                                                   ...
                                                   <div class="modal-content" style="height: 500px;">
                                                       ...
                                                       <div class="modal-body">
                                                           ...
                                                           <div class="row">
                                                               <div class="col-6">
                                                                   <b>Domaine:</b>
                                                                   <span class="text-success">{{$demande->domaine}}</span>
                                                               </div>
                                                               <div class="col-6">
                                                                   <b>Categorie:</b>
                                                                   <span class="text-success">{{$demande->categorie}}</span>
                                                               </div>
                                                           </div> <br>
                                                           ...
                                                           <div class="row">
                                                               <div class="col-6">
                                                                   <b>Sous Domaine :</b>
                                                                   <span class="text-success">{{$demande->sous_domaine}}</span>
                                                               </div>
                                                               <div class="col-6">
                                                                   <b>Commentaire:</b>
