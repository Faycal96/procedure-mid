        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <!-- <img src="img/armoirie.png" width="50px" height="50px"/> -->
                    </a>
                </div>
            ...
            <!-- Settings Dropdown -->
            <div class="hidden dropdown sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        <form class="inline-flex items-center px-3 py-2    leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150"  method="POST" action="{{ route('logout') }}">
                            @csrf
                            <x-dropdown-link :href="route('logout')"
                             onclick="event.preventDefault();
                                        this.closest('form').submit();">
                            <i class="bi bi-box-arrow-right text-danger"> {{ __('Se Déconnecter') }}</i>
                            </x-dropdown-link>
                       </form>
